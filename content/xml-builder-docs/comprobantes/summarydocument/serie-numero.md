...
description: Serie y número en Resúmenes diarios
draft: false
weight: 1
enableToc: false
---
...
La serie y número de un comprobante de Resumen Diario tiene la siguiente estructura: `codigo-fechaEmision-número`. Por ejemplo : `RC-20190101-1`
...
Primera Resumen Diario del día. Incluye una factura:
