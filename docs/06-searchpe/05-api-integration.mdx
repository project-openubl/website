...
Probablemente el en endpoint más importante es `/api/contribuyentes/{numeroDocumento}` ya que este es el usado para consultar personas natural o jurídicas a travéz de su número de DNI o RUC.

Puedes usar el ejemplo de la sección anterior para consumor este endpoint. La respuesta del servidor debe de ser un objeto que tenga la siguiente forma:
