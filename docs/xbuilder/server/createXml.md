...
For creating XML files you need to interact with the set of REST endpoints _XBuilder Server_ exposes to you. For more information about the REST API documentation visit [OpenAPI](./api)
